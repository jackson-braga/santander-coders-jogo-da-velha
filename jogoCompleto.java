...
//        Verifica se o número de partidas é maior ou igual a 1.
        while (partidas < 1){
            System.out.println("O número de paertidas deve ser maior ou igual a 1.");
            System.out.print("Digite o número de partidas: ");
            partidas = scan.nextInt();
        }
...
//      Ou seja, se o valor digitado está no tabuleiro(matriz), se já não foi ocupada ou se todos os elementos da matriz foram ocupados..
        ...
        try {
            if (jogada[linha][coluna].equals(branco)) {
                ...
                validada = true;
            } else if (!jogada[0][0].equals(branco) && !jogada[0][1].equals(branco) && !jogada[0][2].equals(branco)
                    && !jogada[1][0].equals(branco) && !jogada[1][1].equals(branco) && !jogada[1][2].equals(branco)
                    && !jogada[2][0].equals(branco) && !jogada[2][1].equals(branco) && !jogada[2][2].equals(branco)) {
